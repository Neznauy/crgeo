...
describe Crgeo::Coordinates::GradToRad do
  describe "#value" do
    context "when 0 grads" do
      it do
        klass = Crgeo::Coordinates::GradToRad.new(0)
    ...
    context "when 45 grads" do
      it do
        klass = Crgeo::Coordinates::GradToRad.new(45)
    ...
    context "when 60 grads" do
      it do
        klass = Crgeo::Coordinates::GradToRad.new(60)
    ...
    context "when 90 grads" do
      it do
        klass = Crgeo::Coordinates::GradToRad.new(90)
    ...
    context "when 180 grads" do
      it do
        klass = Crgeo::Coordinates::GradToRad.new(180)
