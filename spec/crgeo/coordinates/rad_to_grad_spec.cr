...
describe Crgeo::Coordinates::RadToGrad do
  describe "#value" do
    context "when 0 rads" do
      it do
        klass = Crgeo::Coordinates::RadToGrad.new(0)
    ...
    context "when Pi/4 rads" do
      it do
        klass = Crgeo::Coordinates::RadToGrad.new(Math::PI / 4)
    ...
    context "when Pi/3 rads" do
      it do
        klass = Crgeo::Coordinates::RadToGrad.new(Math::PI / 3)
    ...
    context "when Pi/2 rads" do
      it do
        klass = Crgeo::Coordinates::RadToGrad.new(Math::PI / 2)
    ...
    context "when Pi rads" do
      it do
        klass = Crgeo::Coordinates::RadToGrad.new(Math::PI)
